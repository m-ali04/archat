                                                    ...
                                                    ">
                                                        ...
                                                        ">
                                                            ...
                                                            ">
                                                                        ...
                                                                        <div className="my-2 px-3 py-1 rounded-full bg-slate-600 shadow-lg shadow-gray-950/50 text-sm text-white">
                                                                                {statusText}
                                                                        </div>
                                                                        ...
                                                                        <div className="w-full pb-5 pt-5 sm:px-0 sm:pt-0">
                                                                            <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                                                ...
                                                                                {!data.isGroup && (
                                                                                    <div>
                                                                                        <dt
                                                                                            className="text-sm font-medium text-gray-100 sm:w-40 sm:flex-shrink-0"
                                                                                        >
                                                                                            Email
                                                                                        </dt>
